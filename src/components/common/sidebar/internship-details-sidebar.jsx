...
const InternshipDetailsSidebar = ({ course,details_2=false }) => {
                ...
                <div className="edu-course-widget widget-course-summery">
                    <div className="inner">
                        <div className="thumbnail">
                            <img src={`/assets/images/course/course-01/course-01.jpg`} alt="Course Thumb" />
...
export default InternshipDetailsSidebar;