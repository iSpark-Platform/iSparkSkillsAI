...
const counter_data = [
    {color:'primary-color',number:50,text:'K+',title:'Student Enrolled',decimal: 1},
    {color:'secondary-color',number:0,text:'K',title:'Class Completed',decimal: 1},
    {color:'extra05-color',number:50,text:'+',title:'Top Instructors'},
