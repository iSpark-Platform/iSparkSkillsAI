    ...
    return (
        <div className="edu-sorting-area">
            <div className="sorting-left">
                {
                    items 
                    ? ( <h6 className="showing-text">Showing <span>{num}</span> of <span>{items.length}</span> internships</h6> )
                    : ( <h6 className="showing-text">Showing <span>{num}</span> internships</h6> )
                }
            </div>
            <div className="sorting-right">
                <div className="layout-switcher">
                    ...
                    <ul className="switcher-btn">
                        <li>
                            <Link href="/internship" className={!course_list?"active":''}>
